...
const EnvSchema = z.object({
  ...
  // DB driver selection: "http" (default, serverless app), "pool" (the
  // long-running worker's pooled WebSocket connection), or "node-postgres"
  // for local/CI Postgres integration tests. See db/index.ts.
  DB_DRIVER: z.enum(["http", "pool", "node-postgres"]).optional(),
